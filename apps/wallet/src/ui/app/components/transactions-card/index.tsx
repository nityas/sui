...
import { useTransactionAmount, useTransactionSummary } from '@mysten/core';
import {
...
export function TransactionCard({
    ...
    const transferAmountComponent = amount?.coinType && amount?.total && (
        <CoinBalance
            amount={BigInt(amount?.total) < 0n ? -amount?.total : amount?.total}
