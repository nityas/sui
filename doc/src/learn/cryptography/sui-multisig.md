...
This topic discusses the applications of Multi-Signature and the workflow to create a Multi-Signature transaction in Sui.

# Applications of Multi-Signature

Multi-signature wallets offer several unique benefits to users, from increased security to escrow transactions and 2FA. Unlike conventional MultiSig wallets, a Sui MultiSig account can accept weighted public keys from multiple key schemes. 
